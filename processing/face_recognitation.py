...
def recognize_from_image(query_image_path, known_encodings, known_names):
    ...
    return results #calls recognize_faces and returns the results

def recognize_from_camera(known_encodings, known_names, tolerance=0.6):
    video_capture = cv2.VideoCapture(0)   # continious face recognitation
...
def main(database_dir="/home/aloo/Desktop/SecureBellAI/backend/visitors/verified/ALankrit", query_image_path="backend/visitors/Alankrit/2.jpg", use_camera=True):
