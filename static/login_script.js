...
createacctbtn.addEventListener("click", function(){
    ...
    username = usernameIn.value; // Ensure username is captured
    dob = dobIn.value;
    ...
    if (!signupEmail || !signupPassword || !confirmSignUpPassword || !username || !dob || !gender || !mobile){
    ...
    const data = {
        email: signupEmail,
        name: username, // Include username in the data
